...
using ClinicManagement.Data.Context; // To access your ClinicManagementDbContext
using ClinicManagement.Data.Models;   // To access your Appointment model and other related models
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Appointment>>> GetAppointments()
        {
            ...
            return await _context.Appointments
                                 ...
                                 .Include(a => a.Doctor)  // Include related Doctor (StaffDetail) data
                                 .Include(a => a.Service) // Include related Service data
                                 .ToListAsync();
        }
