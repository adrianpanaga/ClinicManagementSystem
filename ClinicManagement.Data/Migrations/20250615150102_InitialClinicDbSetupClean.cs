...
{
    /// <inheritdoc />
    public partial class InitialClinicDbSetupClean : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__8AFACE3A9237B0E0", x => x.RoleID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CCAC6F5E3381", x => x.UserID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false, defaultValueSql: "('Scheduled')"),
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Roles__8AD57913BB1593DF",
                table: "Roles",
                column: "RoleName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__536C85E484860161",
                table: "Users",
                column: "Username",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Users__A910533139366B96",
                table: "Users",
                column: "Email",
                unique: true);
        }
